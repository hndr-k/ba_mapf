...
//    class eecbs_server : public rclcpp::Node
//    class eecbs_server : public rclcpp_lifecycle::LifecycleNode
class eecbs_server : public nav2_util::LifecycleNode {

public:
  //        eecbs_server(const rclcpp::NodeOptions &options = rclcpp::NodeOptions()) :
  //        Node("mapf_action_server", options), map_(0.25, 3), cbs_() explicit
  //        eecbs_server(const rclcpp::NodeOptions& options = rclcpp::NodeOptions()) :
  //        rclcpp_lifecycle::LifecycleNode("mapf_action_server", options),
  //        map_(0.25, 3), cbs_() eecbs_server() :
  ...
  /// 10, std::bind(&eecbs_server::occ_grid_callback, this, std::placeholders::_1));
  //            service_ =
  ...
  //        }
  ////
  //        explicit eecbs_server(const std:.string & node_name);
  explicit eecbs_server(const rclcpp::NodeOptions &options = rclcpp::NodeOptions());
  // eecbs_server();
  ~eecbs_server();
