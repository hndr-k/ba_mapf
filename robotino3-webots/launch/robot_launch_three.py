...
ARGUMENTS = [
     DeclareLaunchArgument(
            'world',
            default_value='rcll_world_test_3.wbt',
...
def generate_launch_description():
    ...
    controller3 = ControllerLauncher(
        package='webots_ros2_robotino3',
        executable='robotino3_driver_three',
        namespace='robotino3',
        additional_env={'WEBOTS_ROBOT_NAME' : 'robotino3'},
        parameters=[
            configured_params,
            {
                'synchronization': synchronization,
        ...
        output='screen',
        arguments=[
            '--webots-robot-name', 'robotino3',
            '--webots-node-name', 'robotino3'
        ],
        remappings=[('/tf', 'tf'),('/tf_static', 'tf_static')],
    )
    controller4 = ControllerLauncher(
        package='webots_ros2_robotino3',
        executable='robotino3_driver_four',
        namespace='robotino4',
        additional_env={'WEBOTS_ROBOT_NAME' : 'robotino4'},
        parameters=[
            configured_params,
            {
                'synchronization': synchronization,
        ...
        output='screen',
        arguments=[
            '--webots-robot-name', 'robotino4',
            '--webots-node-name', 'robotino4'
        ],
        remappings=[('/tf', 'tf'),('/tf_static', 'tf_static')],
    )
